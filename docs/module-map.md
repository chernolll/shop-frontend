...
| `/bd/kol-prepare` | `views/bd/kol-prepare/index.vue` | `api/bd/kol-prepare.ts` | 达人筹备（独立，与任务解绑） |
| `/bd/kol-pool` | `views/bd/kol-pool/index.vue` | `api/bd/kol-pool.ts` | 达人池（认领公共达人） |
...
| `/kol/pool` | `views/admin/kol-pool/index.vue` | `api/admin/kol-pool.ts` |
