...
> 基于 `docs/ui-system.md` 对全项目页面进行的合规性审计。审计日期：2026-05-14
...
**第二批（P1，预计 3-5 小时）**：3. Review 模块操作列重构（Dropdown 溢出）4. Toolbar 双 slot 结构补全 5. 图标方案决策 + 执行

**第三批（P2，预计 1-2 小时）**：6. reduced-motion 全局适配 7. 状态色常量化 8. 筹备审核详情补强
